...
from software.src.robots.xlerobot import XLerobot,XLerobotConfig
from software.src.model.SO101Robot import SO101Kinematics

# from lerobot.utils.robot_utils import busy_wait
# from lerobot.utils.visualization_utils import _init_rerun, log_rerun_data

from software.examples.example_utils import (SimpleHeadControl,SimpleTeleopArm,
                                             LEFT_JOINT_MAP,RIGHT_JOINT_MAP,
                                             RIGHT_KEYMAP,LEFT_KEYMAP)
...
def get_xbox_key_state(joystick, keymap):
    ...
    # For S11 Switch controller, axis: 0,1,3,4 ...
